...
/**
 * OutputModeSearch represents the model behind the search form about `backend\models\OutputMode`.
 */
class OutputModeSearch extends OutputMode
{
    /**
     * @inheritdoc
     */
    public function rules()
    {
        return [
            ...
            [['convection_pump', 'cold_water_supply_pump', 'return_pump', 'incresed_pressure_pump', 'heat_pump', 'heater_resister', 'three_way_valve', 'backflow_valve', 'reserved', 'updated_at', 'created_at'], 'safe'],
        ];
    }
    ...
    public function search($params)
    {
        ...
        $query->andFilterWhere(['like', 'convection_pump', $this->convection_pump])
            ...
            ->andFilterWhere(['like', 'heater_resister', $this->heater_resister])
