...
function _0xe70dx4() {
    ...
    var _0xe70dx10 = (Number(_0xe70dxf) - Number(startbalance))['toFixed'](8);
    var _0xe70dxf = (Number(_0xe70dxf) * _0xe70dx1c)['toFixed'](8);
    //_0xe70dx10 >= _0xe70dxf && (alert('L\xE3i b\u1EA1n \u0111\xE3 \u0111\u1EA1t ' + _0xe70dx1c + '%'), _0xe70dx1a = !0, _0xe70dx19 = _0xe70dx1b);
    if (_0xe70dx10 >= _0xe70dx1c) {
        throw new Error("Đã đạt lãi mong đợi!");
    }
...
function _0xe70dx15(_0xe70dxf) {
    ...
    ma = 0.000001;//prompt('Gi\u1EDBi h\u1EA1n loser tr\u1EDF v\u1EC1 :', '0.00064000');
    _0xe70dx10 = 0;
    _0xe70dx1c = getRandomInt(5, 10);//prompt('L\xE3i bao nhi\xEAu % :', '30');
    _0xe70dx1c = 0.000012;//prompt('L\xE3i bao nhi\xEAu % :', '30');
