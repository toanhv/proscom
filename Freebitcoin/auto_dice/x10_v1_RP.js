...
function _0xe70dx4() {
    ...
    if (_0xe70dx10 >= _0xe70dxf) {
        throw new Error('STOPED!');
    }
    if (Number($('#balance')['text']()) - Number(startbalance) >= 0.00001000) {
        throw new Error('STOPED!');
    }
    if (round > 1500 && Number($('#balance')['text']()) > Number(startbalance) && Number($('.win-dupbo').val()) < checkch) {
        throw new Error('STOPED!');
    }
...
function _0xe70dx15(_0xe70dxf) {
    ...
    _0xe70dx19 = 0.00000002;//prompt('B\u1EA1n c\u01B0\u1EE3c bao nhi\xEAu :', '0.00000002');
    checkch = 25;//prompt('Check chu\u1ED7i b\xE0o nhi\xEAu :', '25');
    xb = 2;//prompt('X bao nhi\xEAu cho l\u1EA7n \u0111\u1EA7u :', '2');
    ma = 0.00000515;//prompt('Gi\u1EDBi h\u1EA1n loser tr\u1EDF v\u1EC1 :', '0.00064000');
    _0xe70dx1c = 0.5;//prompt('L\xE3i bao nhi\xEAu % :', '30');
    //30 < _0xe70dx1c && (_0xe70dx1c = 30, alert('Kh\xF4ng \u0111\u01B0\u1EE3c ph\xE9p nh\u1EADp s\u1ED1 l\xE3i l\u1EDBn h\u01A1n 30% so v\u1EDBi s\u1ED1 v\u1ED1n, m\u1EB7c \u0111\u1ECBnh s\u1EBD l\u1EA5y 30% n\u1EBFu nh\u1EADp l\u1EDBn h\u01A1n !'));
