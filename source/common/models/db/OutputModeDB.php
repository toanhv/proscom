...
/**
 * This is the model class for table "output_mode".
 *
 * @property string $id
 ...
 * @property string $heater_resister
 ...
 */
class OutputModeDB extends \yii\db\ActiveRecord
{
    /**
     * @inheritdoc
     */
    ...
    public function rules()
    {
        return [
            ...
            [['convection_pump', 'cold_water_supply_pump', 'return_pump', 'incresed_pressure_pump', 'heat_pump', 'heater_resister', 'three_way_valve', 'backflow_valve', 'reserved'], 'string', 'max' => 255]
        ];
    }
    ...
    public function attributeLabels()
    {
        return [
            ...
            'heater_resister' => Yii::t('backend', 'Heater Resister'),
