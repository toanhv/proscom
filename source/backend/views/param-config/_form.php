<div class="item" data-toggle="tooltip" class="text-04" data-placement="right" title="<?php echo Yii::t('backend', 'Water temperature difference between Solar panels and Solar tank'); ?>"> 
    ...
    <p>
        <?php echo Yii::t('backend', 'Range to turn on the pump'); ?> <input type="number" name="convection_pump" value="<?php echo $model->getConvectionTemp(); ?>" class="type-text" style="width:40px"><sup>o</sup>C
    </p>
</div>
...
<div class="item" data-toggle="tooltip" class="text-04" data-placement="right" title="<?php echo Yii::t('backend', 'Pump ON when water level lower than M2 and OFF when water level upper than M1'); ?>"> 
    ...
    <p>
        <?php echo Yii::t('backend', 'Water level M1'); ?> <input type="number" name="cold_water_supply_pump_lv1" value="<?php echo $model->getCwsplv1(); ?>" class="type-text" style="width:40px">
    </p>
    <p>
        <?php echo Yii::t('backend', 'Water level M2'); ?> <input type="number" name="cold_water_supply_pump_lv2" value="<?php echo $model->getCwsplv2(); ?>" class="type-text" style="width:40px">
    </p>
</div>
...
<div class="item" data-toggle="tooltip" class="text-04" data-placement="right" title="<?php echo Yii::t('backend', 'Pump ON when time out of Begin time and End time, and the temperature between Heater tank and pipeline upper than range'); ?>">        	
    ...
    <p>
        ...
        <input type="number" name="return_pump_t1_start" value="<?php echo bindec(substr($model->return_pump, 0, 8)); ?>" class="type-text" style="width:40px"> : 
        <input type="number" name="return_pump_t1_end" value="<?php echo bindec(substr($model->return_pump, 8, 8)); ?>" class="type-text" style="width:40px">
    </p>
    <p>
        <?php echo Yii::t('backend', 'End ilde time'); ?>  (hh:mm)
        <input type="number" name="return_pump_t2_start" value="<?php echo bindec(substr($model->return_pump, 16, 8)); ?>" class="type-text" style="width:40px"> : 
        <input type="number" name="return_pump_t2_end" value="<?php echo bindec(substr($model->return_pump, 24, 8)); ?>" class="type-text" style="width:40px">
    </p>
    <p>
        <?php echo Yii::t('backend', 'Range to turn on the Pump'); ?> <input type="number" name="return_pump_delta_t" value="<?php echo $model->getReturnPumpDeltat(); ?>" class="type-text" style="width:40px"><sup>o</sup>C
    </p>
</div>
...
<div class="item" data-toggle="tooltip" class="text-04" data-placement="right" title="<?php echo Yii::t('backend', 'Pump ON when temperqature in the Heater tank lower than this value'); ?>"> 
    ...
    <p>
        <?php echo Yii::t('backend', 'Temperature to turn on the Pump'); ?> <input type="number" name="heat_pump_t1" value="<?php echo $model->getHeatPumpT1(); ?>" class="type-text" style="width:40px"><sup>o</sup>C
    </p>
</div>
...
<div class="item" data-toggle="tooltip" class="text-04" data-placement="right" title="<?php echo Yii::t('backend', 'Valve change direction when time out of Begin time and End time, and the temperature between Heater tank and Solar tank upper than range'); ?>">        	
    ...
    <p>
        <?php echo Yii::t('backend', 'Begin ilde time'); ?> (hh:mm)
        <input type="number" name="3way_t1_h" value="<?php echo bindec(substr($model->three_way_valve, 0, 8)); ?>" class="type-text" style="width:40px"> : 
        <input type="number" name="3way_t1_m" value="<?php echo bindec(substr($model->three_way_valve, 8, 8)); ?>" class="type-text" style="width:40px">
    </p>
    <p>
        <?php echo Yii::t('backend', 'End ilde time'); ?> (hh:mm)
        <input type="number" name="3way_t2_h" value="<?php echo bindec(substr($model->three_way_valve, 16, 8)); ?>" class="type-text" style="width:40px"> : 
        <input type="number" name="3way_t2_m" value="<?php echo bindec(substr($model->three_way_valve, 24, 8)); ?>" class="type-text" style="width:40px">
    </p>
    <p>
        <?php echo Yii::t('backend', 'Range to change direction'); ?> <input type="number" name="3way_temp" value="<?php echo $model->get3wayTempDelta(); ?>" class="type-text" style="width:40px"><sup>o</sup>C
    </p>
</div>
...
<div class="item" data-toggle="tooltip" class="text-04" data-placement="right" title="<?php echo Yii::t('backend', 'When temperature in the pipeline lower than this value, Valve open'); ?>"> 
    ...
    <p>
        <?php echo Yii::t('backend', 'Temperature to turn on the Pump'); ?> <input type="number" name="backflow_temp" value="<?php echo $model->getBackflowTemp(); ?>" class="type-text" style="width:40px"><sup>o</sup>C
    </p>
</div>
