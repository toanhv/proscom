<div class="item" data-toggle="tooltip" class="text-04" data-placement="right" title="Counter must be an integer and must be no less than 0">
    <h3 style="margin-bottom:10px">Counter</h3>       	
    <p>
...
<div class="item" data-toggle="tooltip" class="text-04" data-placement="right" title="Counter must be an integer and must be no less than 5"> 
    <h3 style="margin-bottom:10px">Confirm Timer</h3>       	
    <p>
...
<div class="item" data-toggle="tooltip" class="text-04" data-placement="right" title="Counter must be an integer and must be no less than 60"> 
    <h3 style="margin-bottom:10px">Resend Timer</h3>       	
    <p>
...
<div class="item" data-toggle="tooltip" class="text-04" data-placement="right" title="Counter must be an integer and must be no less than 180"> 
    <h3 style="margin-bottom:10px">Report Timer</h3>       	
    <p>
