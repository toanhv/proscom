    ...
    <form method="post" id="form-choose-mode" action="/modules/mode?id=<?php echo $module->id ?>">
        ...
        <div class="check-account">
            ...
            <div class="row-check-account">
                ...
                <p align="center">
                    <a href="javascript:void(0)" onclick="$('#form-choose-mode').submit()" class="btn btn-primary" data-confirm="<?php echo Yii::t('backend', 'Are you sure you want to send?'); ?>"><?php echo Yii::t('backend', 'SEND'); ?></a>
                </p>
            </div>
        </div>
    </form>
